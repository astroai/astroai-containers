#!/usr/bin/bash
# Smoke test: astroai status team project + quotas in astroai/base.
set -euo pipefail
...
echo "astroai status arc project test (${IMAGE})"
echo "=============================================="
...
echo "astroai status arc project test passed."
